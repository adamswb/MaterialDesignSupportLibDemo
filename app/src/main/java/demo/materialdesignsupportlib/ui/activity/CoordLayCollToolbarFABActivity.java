...
public class CoordLayCollToolbarFABActivity extends AppCompatActivity implements ScrollFlagDialogFragment.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cl_coll_toolbar);
